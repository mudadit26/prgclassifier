...
PREDICTED_LABELS = ["Disk", "Smooth","Polar Ring"]


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/e8df2f20-e592-493b-b1c1-31992eccf427'
...
st.title(":blue[PRG Classifier]")#change according to your project
